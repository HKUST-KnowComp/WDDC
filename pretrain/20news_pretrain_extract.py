...
parser.add_argument('--save_dir', type=str, default="../data/20news_extract/saved_model",
                    help='path to model saving directory')
parser.add_argument('--data_dir', type=str, default="../data/20news_extract",
                    help='path to data directory')
parser.add_argument('--esa_dir', type=str, default="data/20news_extract",
                    help='path to data directory')
parser.add_argument('--esa_file', type=str, default="train_plus_test_esa_similarity.npy",
                    help='path to data directory')
parser.add_argument('--log_dir', type=str, default="../log/20news_extract",
