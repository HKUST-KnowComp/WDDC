...
parser.add_argument('--save_dir', type=str, default="../data/ucinews_extract/saved_model",
                    help='path to model saving directory')
parser.add_argument('--data_dir', type=str, default="../data/ucinews_extract",
                    help='path to data directory')
parser.add_argument('--esa_dir', type=str, default="../data/ucinews_extract",
                    help='path to data directory')
parser.add_argument('--esa_file', type=str, default="esa_similarity.npy",
                    help='path to data directory')
parser.add_argument('--log_dir', type=str, default="../log/ucinews_extract",
...
parser.add_argument('--score_scale', type=int, default=4,
