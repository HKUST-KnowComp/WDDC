...
parser.add_argument('--num_chunk', type=int, default=3,
...
parser.add_argument('--esa_dir', type=str, default="./data/ucinews_bert",
                    help='path to data directory')
parser.add_argument('--esa_file', type=str, default="esa_similarity.npy",
                    help='path to data directory')
parser.add_argument('--log_dir', type=str, default="./log/ucinews_bert",
